                                                            ...
                                                            {printer.type === 'usb' ? (
                                                                ...
                                                                <>
                                                                    <div className="flex items-center justify-between p-3 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-600/50 rounded-xl border-l-4 border-gray-400">
                                                                        ...
                                                                        <span className="font-bold text-gray-900 dark:text-gray-100">{printer.host || '-'}</span>
                                                                    </div>
                                                                    <div className="flex items-center justify-between p-3 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-600/50 rounded-xl border-l-4 border-gray-400">
                                                                        <span className="text-gray-600 dark:text-gray-400 font-medium">Porta:</span>
                                                                        <span className="font-bold text-gray-900 dark:text-gray-100">{printer.port || '-'}</span>
                                                                    </div>
                                                                </>
                                                            )}
                                                        </div>
