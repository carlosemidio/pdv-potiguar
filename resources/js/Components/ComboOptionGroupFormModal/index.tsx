            ...
            <div className="bg-white rounded-xl shadow-2xl overflow-hidden max-w-2xl w-full mx-4">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-teal-100 text-sm">
                                    Configure um novo grupo de seleção para o combo
                                </p>
                            </div>
                        </div>
                        <Button
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="bg-gray-50 rounded-lg p-4">
                            ...
                            <input
                                ...
                                placeholder="Ex: Bebidas, Acompanhamentos"
                                required
                                disabled={processing}
                            />
                        </div>
                ...
                <div className="bg-gray-50 px-6 py-4 flex justify-end space-x-3">
                    ...
                    <button
                        ...
                        onClick={submit}
                        disabled={processing}
                        className="px-4 py-2 bg-gradient-to-r from-teal-500 to-cyan-600 text-white rounded-lg hover:from-teal-600 hover:to-cyan-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
                    >
                        {processing ? (
