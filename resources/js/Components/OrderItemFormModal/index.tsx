        ...
        <Modal show={isOpen} onClose={onClose}>
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden max-w-4xl w-full max-h-[95vh] flex flex-col">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-gradient-to-r from-gray-50 to-slate-50 dark:from-gray-700/50 dark:to-slate-600/50 rounded-xl p-6 border-l-4 border-gray-400">
                            ...
                            <div className="relative">
                                ...
                                <textarea
                                    id="notes"
                                    className="block w-full pl-11 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm focus:border-gray-500 focus:ring-gray-500 dark:bg-gray-700 dark:text-gray-100 bg-white text-gray-900 transition-colors duration-200 resize-none"
                                    value={data.notes ?? ''}
                ...
                <div className="flex-shrink-0 bg-gray-50 dark:bg-gray-700/50 px-6 py-4 border-t border-gray-200 dark:border-gray-700">
                    {/* Subtotal */}
                    <div className="flex items-center justify-between mb-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl border border-green-200 dark:border-green-800">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        <button
                            ...
                            className="order-1 sm:order-2 w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 disabled:from-gray-400 disabled:to-gray-500 text-white rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl disabled:cursor-not-allowed transform hover:-translate-y-0.5"
                        >
                            {processing ? (
                                <>
